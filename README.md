...
> โดยสรุปแล้วหากต้องการที่จะ Focus ในกลุ่มลูกค้าที่สำคัญ ๆ ก็อาจจะต้อง Focus แค่ cluster 1 และ cluster 3 ที่มี spending scores ที่สูง แต่ว่าในสองกลุ่มนี้ก็มีความต่างของรายได้ต่อปีที่ค่อนข้างมาก (เฉลี่ยแล้วต่างกันประมาณ 60,000 $ (คิดจาก distance ระหว่างจุด centroids 2 จุด) คิดเป็นเงินไทยประมาณ 2,020,740 THB)
